...
$comment = mysqli_query($conn, "SELECT comment.*, post.tittle
        FROM comment, post
                    ...
                    <div class="col-lg-12">
                        <form role="form" action="" method="post">
                                ...
                                <select class="form-control" name="post_id">
                                    ...
                                    <?php if(mysqli_num_rows($post)>0) { ?>
                                        <?php while($row_post = mysqli_fetch_array($post)) { ?>
                                            ...
                                            value="<?php echo $row_post["id"] ?>"> <?php echo $row_post["tittle"] ?> </option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="0" name="status" <?php echo $row_edit["status"]=='0' ? "checked" : "" ?> checked /> Not Active
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php if(mysqli_num_rows($comment)>0) { ?>
                            ...
                            <tr>
                                <td><?php echo $row_comment["tittle"] ?></td>
