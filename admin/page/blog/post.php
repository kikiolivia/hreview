...
if(isset($_POST["submit"])) {
    ...
    mysqli_query($conn, "INSERT INTO post VALUES('', '$category_id', '$tittle', '$description', '$description1', '$description2', '$description3', '$file_name', '$date')");
                    ...
                    <div class="col-lg-12">
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="description3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Image</label>
